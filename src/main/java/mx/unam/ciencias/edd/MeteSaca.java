...
public abstract class MeteSaca<T> {
	...
	Nodo elementoExtremo = cabeza;
	cabeza = cabeza.siguiente;
	if (cabeza == null)
	    rabo = null;
	return elementoExtremo.elemento; 
    }
	...
	Nodo otroNodo = m.cabeza;
	Nodo nodo = this.cabeza;
	
	while (nodo != null && otroNodo != null){
	    if (!nodo.elemento.equals(otroNodo.elemento))
		return false;
	    nodo = nodo.siguiente;
	    otroNodo = otroNodo.siguiente;
	}
	   
	return otroNodo == null && nodo == null;
    }
}
