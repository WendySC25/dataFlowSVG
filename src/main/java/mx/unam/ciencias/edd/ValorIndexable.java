...
public class ValorIndexable<T>
    ...
    @Override public int compareTo(ValorIndexable<T> valorIndexable) {
        double diferencia = this.valor -  valorIndexable.valor;
        if (diferencia == 0)
            return 0;
    ...
    @Override public boolean equals(Object objeto) {
       ...
       return valorIndexable.elemento.equals(this.elemento) &&
              valorIndexable.indice == this.indice &&
              valorIndexable.valor == this.valor;
    }
    ...
    @Override public String toString() {
        return String.format("%s:%2.9f", elemento, this.valor);
    }
}
