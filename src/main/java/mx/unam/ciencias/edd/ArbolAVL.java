...
public class ArbolAVL<T extends Comparable<T>>
	...
	/**
	    ...
	    return (this.altura == vertice.altura && super.equals(vertice));
        }
	...
	case 2:
		...
		actulializaAltura(vertice);
		actulializaAltura(hijoIzquierdo);
	    }
    ...
    private void actulializaAltura(VerticeAVL vertice){
	vertice.altura = 1 + Math.max(altura(verticeAVL(vertice.izquierdo)), altura(verticeAVL(vertice.derecho)));
    }
