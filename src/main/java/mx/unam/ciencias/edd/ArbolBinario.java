...
public abstract class ArbolBinario<T> implements Coleccion<T> {
	...
	private int altura(Vertice vertice){
	    return vertice == null ?
		-1 : 1 + Math.max(altura(vertice.izquierdo), altura(vertice.derecho));
	}
	...
	if (vertice.elemento.equals(elemento))
        ...
        VerticeArbolBinario<T> verticeIzquierdo = busca(vertice.izquierdo, elemento);
        VerticeArbolBinario<T> verticeDerecho = busca(vertice.derecho, elemento);

	return verticeIzquierdo != null ? verticeIzquierdo : verticeDerecho;
	...
	if (esVacia())
	    throw new NoSuchElementException("La raíz del árbol es vacía. ");
	return raiz;
    }
	...
	return
	    toString(raiz, 0, new boolean[altura() + 1]);
    }

    private String toString(Vertice v, int l, boolean[] a){ //l es de level
	String s = v.toString() + "\n";
        a[l] = true;
